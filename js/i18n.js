...
(function () {
  ...
  var T = {
    ja: {
      ...
      tba_account_notice: 'このアカウントはTBA（Token Bound Account）です',
      tba_parent_nft: '親NFT',
      tba_controller: '操作者（オーナー）',
      tba_held_assets: 'TBA保有アセット',
      attributes: '属性',
      owner: '所有者',
      send_to: '送り先アドレス',
      ...
      confirm_remove_admin: 'を管理者から削除しますか？',
      creator_list: '作家一覧',
      add_creator: '作家を追加',
      edit_creator: '作家を編集',
      creator_added: '作家を追加しました',
      creator_updated: '作家情報を更新しました',
      creator_removed: '作家を削除しました',
      confirm_remove_creator: 'を削除しますか？',
      creator_visible: '公開にしました',
      creator_hidden: '非公開にしました',
      name_ja: '名前（日本語）',
      name_en: '名前（英語）',
      name: '名前',
      type: 'タイプ',
      ...
      mint_to: 'ミント先アドレス',
      mint_to_self: '自分宛て',
      mint_sbt_warning: '⚠️ これはSBT（譲渡不可トークン）です。ミント後は転送・移動できません。ミント先アドレスを十分に確認してください。',
    ...
    en: {
      ...
      tba_account_notice: 'This account is a TBA (Token Bound Account)',
      tba_parent_nft: 'Parent NFT',
      tba_controller: 'Controller (Owner)',
      tba_held_assets: 'Assets held by TBA',
      ...
      confirm_remove_admin: ': Remove from admin?',
      creator_list: 'Artist List',
      add_creator: 'Add Artist',
      edit_creator: 'Edit Artist',
      creator_added: 'Artist added successfully',
      creator_updated: 'Artist info updated',
      creator_removed: 'Artist removed successfully',
      confirm_remove_creator: ': Remove this artist?',
      creator_visible: 'Set to visible',
      creator_hidden: 'Set to hidden',
      ...
      mint_to: 'Mint To',
      mint_to_self: 'Self',
      mint_sbt_warning: '⚠️ This is an SBT (non-transferable token). It cannot be transferred after minting. Please double-check the recipient address carefully.',
